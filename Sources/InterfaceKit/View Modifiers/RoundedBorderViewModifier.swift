...
public struct RoundedBorderViewModifier : ViewModifier {
    ...
    public init(cornerRadius: CGFloat = 6.0, lineWidth: CGFloat = 1.0, lineColor: Color = Color.secondary.opacity(0.7), innerPadding: EdgeInsets = EdgeInsets(top: 2.0, leading: 4.0, bottom: 2.0, trailing: 4.0)) {
